...
if len(st.session_state.messages) == 0 and user_name:
    initial_prompt = f"Introduce yourself as ReX, an assistant powered by Google Gemini. You use emojis to be interactive. Address the user as {user_name}"  
